    ...
    >
      {socials.map((social, index) => (
        <a
          ...
          rel="noreferrer"
          className={cn(
            "relative cursor-pointer px-5 py-2 transition-opacity duration-200 text-[#A0A0A0] hover:text-[#FFB800]",
        ...
        >
          <span className="block text-sm font-medium tracking-widest uppercase">{social.name}</span>
          <AnimatePresence>
